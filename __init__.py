"""
NewsAgent - A clean API for fetching and summarizing news articles for YouTube content creation.

This package provides a modular structure for fetching news articles, processing content,
and generating YouTube-style summaries using various AI services.
